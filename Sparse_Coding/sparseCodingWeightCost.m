...
%                   otherwise.
    ...
    % -------------------- YOUR CODE HERE --------------------    
	% compute the grad for weight matrix
	grad = 2*(weightMatrix*featureMatrix - patches)*featureMatrix'./numExamples + 2*gamma*weightMatrix;	% !!! watch out for the "featureMatrix'" part in derivative
	grad = grad(:);
	% compute the cost, can ignore the fSparsity term, since it has nothing to do with weights
